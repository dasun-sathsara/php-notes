...
<div class="flex flex-col items-center justify-center my-12 lg:py-0">
            ...
            <form class="space-y-4 md:space-y-6" action="/session" method="POST">
                <div>
                    ...
                    <?php if (isset($errors['email'])) : ?>
                        <p id="email-error" class=" text-sm text-red-600 dark:text-red-500"><?= $errors['email'] ?></p>
                    <?php endif; ?>
                </div>
                <div>
                ...
                <?php if (isset($errors['login'])) : ?>
                    <div>
                        <p id="general-error" class=" text-sm text-red-600 dark:text-red-500"><?= $errors['login'] ?></p>
                    </div>
                <?php endif; ?>
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    Don't have an account? <a href="/register" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Create account</a>
                </p>
            </form>
        </div>
    </div>
